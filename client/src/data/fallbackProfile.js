// Mirrors server/data/profile.js — used if the API is unreachable so the UI never breaks.
export const fallbackProfile = {
  ...
  phone: "+91 8928615023",
  summary:
    "IT engineering student at KJ Somaiya College of Engineering (CGPA 9.55, Honors in AI) and Technical Intern at ARCON.",
  links: {
